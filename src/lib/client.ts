...
export function Environment(name: string): BaseURL {
  return `https://${name}-eci-ocw2.encr.app`;
}
...
/**
 * Client is an API client for the eci-ocw2 Encore application.
 */
...
export namespace api {
  ...
  export class ServiceClient {
     ...
     * Create property
     */
    public async create(params: CreatePropertyParams): Promise<{
      /**
       * Create property
       */
      property: Property;
     ...
     * List properties
     */
    public async list(params: ListPropertiesParams): Promise<{
      /**
       * List properties
       */
      properties: Property[];
  ...
  constructor(baseURL: string, options: ClientOptions) {
    ...
    if (typeof window === "undefined") {
      this.headers["User-Agent"] =
        "eci-ocw2-Generated-TS-Client (Encore/v1.46.6)";
    }
